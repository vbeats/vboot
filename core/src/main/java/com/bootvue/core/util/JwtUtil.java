...
public class JwtUtil {
    private static final String iss = "vboot";
    private static final SignatureAlgorithm signatureAlgorithm = SignatureAlgorithm.HS256;

    // 签名密钥
    private static final String key = Base64Utils.encodeToString("G7$Y75584iow#r7F!WW40TX*5gdgY^&&9Ox^7Fy6ApIAUj0NvL1LYZfzJ%ye6unO".getBytes());
